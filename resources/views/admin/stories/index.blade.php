...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class=" d-flex  justify-content-between card-header">Deleted Stories
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form style="display: inline-block"
                                        action="{{ route('admin.stories.restore' , [$story]) }}" method="post">
                                        @method('put')
                                        @csrf
                                    ...
                                    <form style="display: inline-block"
                                        action="{{ route('admin.stories.delete' , [$story]) }}" method="post">
                                        @method('delete')
                                        @csrf
